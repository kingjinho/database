...
const uint32_t PAGE_SIZE = 4096; // same size as a page used in virtual memory system of most computer architectures
...
int main(int argc, char *argv[])
{
    ...
    while (true)
    {
        ...
        // front-end part start

        // check non-sql statements like .exit
